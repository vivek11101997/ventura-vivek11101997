...
import styles from "../../../components/clientOnboarding/WelcomToVentura/Welcome.module.css";
      ...
      <section className="ContainerBG">
        ...
        <div className="containerMini">
          ...
          <div className="animate__animated pb20">
            <ButtonUI
              onClick={() => router.push(addBankAccount)}
              type={"submit"}
            >
              Continue
            </ButtonUI>
...
export default CompletedBankAccountAdd;
