...
import ShareLink from "../../ui/Popups/Sharelink/Sharelink.component";
import Script from "next/script";
import SelfiePreview from "./SelfiePreview.component";
      ...
      <section className="ContainerBG">
        <div className="containerMini">
          ...
          <div className="animate__animated btn-sticky">
            ...
            <button onClick={ShareLinkFc} className={styles.link}>
              Share a link to another device
            </button>
          </div>
          ...
          {showModal && (
            <>
              ...
              {base64ImageReceived && (
                <Modal ModalType="signature_modal" onClick={toggleModal}>
                  <SelfiePreview base64Image={base64Image} />
                </Modal>
              )}
...
export default connect(mapStateToProps, mapDispatchToProps)(TakeSelfie);
